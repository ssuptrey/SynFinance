...
class DatabaseConfig:
    ...
    username: str = "synfinance_trey",
    password: str = "synfinance_guccigeng77@",
        pool_size: int = 10,
        max_overflow: int = 20,
        pool_timeout: int = 30,
    ...
    def from_env(cls) -> "DatabaseConfig":
        ...
        return cls(
            ...
            username=os.getenv("DB_USER", "synfinance_trey"),
            password=os.getenv("DB_PASSWORD", "synfinance_guccigeng77@"),
